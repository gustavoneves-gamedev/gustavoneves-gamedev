...
- 🌀 wave progression and arena flow  
- 🎯 build-crafting systems  
- 🧩 modular gameplay logic & clean code architecture  
- ✨ gameplay feedback (clarity, impact, progression and rewards)
...
- Player Abilities & Progression Systems

### **Art & Tools**
- Blender (3D modeling)
- Photoshop / Krita
- Unity VFX Graph & Shader Graph (intermediary)
- Git, GitHub Desktop, Rider / Visual Studio
...
- 🎓 Digital Games student @ **PUC Minas**
- 💼 Solo developer behind **Snows Studios**
- 🌍 Belo Horizonte · Brazil  
- 🎯 Focused on gameplay systems, abilities, and progression  
- 🎵 Outside of dev: sci-fi, Stephen King and RPGs  

I’m currently improving:
- player-centric design  
- gameplay modularity  
- system clarity & balance  
- stylized visuals  
...
📧 Email: **gustavo.neves.1995@gmail.com**  
🎮 Itch.io: https://snowsstudios.itch.io  
